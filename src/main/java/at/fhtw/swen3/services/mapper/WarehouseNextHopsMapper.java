...
public interface WarehouseNextHopsMapper {
    ...
    WarehouseNextHopsEntity dtoToEntity(WarehouseNextHopsDto warehouseNextHopsDto);
    WarehouseNextHopsDto entityToDto(WarehouseNextHopsEntity warehouseNextHops);
}
